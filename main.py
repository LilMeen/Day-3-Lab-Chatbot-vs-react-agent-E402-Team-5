...
def main():
    url = "https://cinestar.com.vn/movie/0727eff6-6f7c-44e3-a0a5-6dfc05257b18/"
    schedules = get_movie_schedules(url, debug_html=True)

    print(f"Total schedules: {len(schedules)}")
    for theatre, day, time in schedules[:30]:
        print(f"Theatre: {theatre}, Day: {day}, Time: {time}")
